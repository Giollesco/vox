 ...
 * APP_ENV is passed as an inline variable while executing the command, for example: APP_ENV=development pnpm build:android
 */
const z = require('zod');
 ...
 * for example: if the APP_ENV is development, the bundle id will be com.vox.development
 */

const BUNDLE_ID = 'com.vox'; // ios bundle id
const PACKAGE = 'com.vox'; // android package name
const NAME = 'Vox'; // app name
const EXPO_ACCOUNT_OWNER = 'giollesco'; // expo account owner
const EAS_PROJECT_ID = '698e9cb2-ddd4-4747-9dcb-8be5ca9c01d2'; // eas project id
const SCHEME = 'vox'; // app scheme
...
const _buildTimeEnv = {
  ...
  EAS_PROJECT_ID,
  //! BUILD ENV VARS
  // SECRET_KEY: process.env.EXPO_PUBLIC_PROJECT_ID,
};
